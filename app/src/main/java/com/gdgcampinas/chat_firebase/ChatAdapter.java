...
//        }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.mTextView.setText(chat.getFirstname());
        holder.mTextView.setText(chat.getLastname());
    }
    @Override
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View v) {
            super(v);
            mTextView = (TextView) itemView.findViewById(R.id.firstnameTextView);
            mTextView = (TextView) itemView.findViewById(R.id.lastnameTextView);
        }
    }
}
